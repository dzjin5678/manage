                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:1300px">
                            <div class="header">
                                <legend>添加船舶动态信息</legend>
                            </div>
                            <div class="content">
                                <form method="post" action="/manage/ship_dynamic/insert" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group" type>
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" name="shipForecastId" class="form-control" id="shipForecastId" value="${shipForecastId }"  readonly="readonly">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                       	...
                                       	<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="arriveAnchorage" class="form-control" id="arriveAnchorage" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="entryTime" class="form-control datetimepicker" id="entryTime" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="departureTime" class="form-control datetimepicker" id="departureTime" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <!-- <input type="text" name="entryDeparture" class="form-control" id="entryDeparture" > -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="firstCableTime" class="form-control datetimepicker" id="firstCableTime" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="berthingTime" class="form-control datetimepicker" id="berthingTime" > 
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="transportMode" class="form-control" id="transportMode" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="lastPort" class="form-control" id="lastPort" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="nextPort" class="form-control" id="nextPort" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="loadUnloadCategory" class="form-control" id="loadUnloadCategory" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <!-- <input type="text" name="reservoirArea" class="form-control" id="reservoirArea" > -->
                                                ...
                                                <c:forEach items="${StoragecodeList}" var="sc" >
													<option value="${sc.storageName }">${sc.storageName }</option>
												</c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <!-- <input type="text" name="wharf" class="form-control" id="wharf" > -->
                                                ...
                                                <c:forEach items="${WharfcodeList}" var="wl" >
													<option value="${wl.wharfName }">${wl.wharfName }</option>
												</c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="berth" class="form-control" id="berth" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <!-- <input type="text" name="waterDiversionTug" class="form-control" id="waterDiversionTug" > -->
                                                <select name="waterDiversionTug" class="selectpicker" data-title="请选择" data-style="btn-default btn-block" data-menu-style="dropdown-blue">
	                                                <option value="0">引水</option>
	                                                <option value="1">拖轮</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <!-- <input type="text" name="reservoirShippingFreightForwarding" class="form-control" id="reservoirShippingFreightForwarding" > -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="arrivalTime" class="form-control datetimepicker" id="arrivalTime" >
                                            </div>
                                        </div>
                                    ...
                                    <span style="color: #FF0000">${errorInfo}</span><br>
                                         <a href="/manage/ship_dynamic/shipdynamic?shipForecastId=${shipForecastId }"  class="btn btn-info btn-fill">返回</a>
