                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            ...
                            <div class="content">
                                <form method="post" action="/manage/cargoNameCode/updateCargoNameCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                    <c:forEach items="${cargoNameCodeList}" var="cargoName">
                                    
                                        <div class="form-group" style="display:none;">
                                            <label class="col-sm-3 control-label">ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="id" class="form-control" id="number" value="${ cargoName.id}">
                                            </div>
                                        </div>
                                    
                                       <div class="form-group">
                                            <label class="col-sm-3 control-label">货名代码</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="cargoNameCode" class="form-control" id="number" value="${ cargoName.cargoNameCode}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="cargoName" class="form-control" id="number" value="${ cargoName.cargoName}">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">所属货类</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="cargoTypeBelonged" class="form-control" id="number" value="${ cargoName.cargoTypeBelonged}">
                                            </div>
                                        </div>
                                    ...
                                    <span style="color: #FF0000">${addCargoNameCodeErrorInfo}</span><br>
                                         <a href="/manage/cargoNameCode/queryCargoNameCode?page=1&strip=10" class="btn btn-info btn-fill">返回</a>
