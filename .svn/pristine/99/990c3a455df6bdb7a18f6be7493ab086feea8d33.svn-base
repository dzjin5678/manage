                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:1000px">
                            ...
                            <div class="content">
                                <form method="post" action="/manage/storageTankCode/updateStorageTankCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                    	<c:forEach items="${storageTanks}" var="storageTank">
                                        <div class="form-group" style="display:none;">
                                            <label class="col-sm-3 control-label">ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="id" class="form-control" id="number" value="${storageTank.storageTankNumber}">
                                            </div>
                                        </div>
                                    
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">储罐列位置</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="tankColumn" class="form-control" id="number" value="${storageTank.tankColumn}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="storageTankNumber" class="form-control" id="number" value="${storageTank.storageTankNumber}">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">储罐位置</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="storageTankPosition" class="form-control" id="number" value="${storageTank.storageTankPosition}">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">储罐设计容量</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="storageTankCapacity" class="form-control" id="number" value="${storageTank.storageTankCapacity}">
                                            </div>
                                        </div>
                                        </c:forEach>
                                    ...
                                    <span style="color: #FF0000">${errorInfo}</span><br>
                                         <a href="/manage/storageTankCode/queryStorageTankCodeList?page=1&strip=10" class="btn btn-info btn-fill">返回</a>
