                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="title">货名管理</h4>
                                    </div>
                                    
                                    <div class="col-md-3" >
                                    <br>
                                    <a class="btn btn-primary btn-fill" href="/manage/code/addCargoNameCode.jsp">添加货名信息</a>
                            		</div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <td><h5>更新</h5></td>
                                  	...
                                  	<tbody>
										<c:forEach items="${cargoNameList}" var="cargoName" >
										<tr>
		                                        <td>${cargoName.cargoNameCode}</td>
		                                        <td>${cargoName.cargoName}</td>
		                                        <td>${cargoName.cargoTypeBelonged}</td>
		                                        <td><a href="#" onclick="deleteRole('${cargoName.id}')">删除</a></td>
		                                        <td><a href="#" onclick="updateCargoName('${cargoName.id}')">更新</a></td>
		                                </tr>
										</c:forEach>
                                    </tbody>
                                </table>
...
<script>
	...
	function deleteRole(id) {
    	...
    	if (r==true){
    		...
    		$.ajax({
    	        type: "post",
    	        url: "/manage/cargoNameCode/deleteCargoNameCode",
    	        datatype: "json",
    	        async: false,
    	        data:{
    	            id:id
    	        ...
    	        success:function (data) {
    	        	window.location.href="/manage/cargoNameCode/queryCargoNameCode?page="+${page}+"&strip=10";
    	        },
    	        error:function(res){
    	            alert("联网失败");
    	        }
	...
	function updateCargoName(id) {
		...
		$.ajax({
	        type: "post",
	        url: "/manage/cargoNameCode/getCargoNameCode?id="+id,
	        datatype: "json",
	        async: false,
	        data:{
	            id:id
	        ...
	        success:function () {
	        	window.location.href="/manage/code/updateCargoNameCode.jsp";
	        },
	        error:function(res){
	            alert("联网失败");
	        }
