                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            <div class="header">
                                <legend>添加费用代码</legend>
                            </div>
                            <div class="content">
                                <form method="post" action="/manage/costCode/insertCostCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">费目代码</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="costCode" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="costName" class="form-control" id="number" >
                                            </div>
                                        </div>
                                       	...
                                       	<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="costUnit" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="costRate" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="costType" class="form-control" id="number" >
                                            </div>
                                        </div>
