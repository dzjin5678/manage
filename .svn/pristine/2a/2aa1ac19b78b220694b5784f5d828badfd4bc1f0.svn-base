                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="title">货类管理</h4>
                                    </div>
                                    
                                    <div class="col-md-3" >
                                    <br>
                                    <a class="btn btn-primary btn-fill" href="/manage/code/addCargoTypeCode.jsp">添加货类信息</a>
                            		</div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <td><h5>更新</h5></td>
                                  	...
                                  	<tbody>
										...
										<tr>
		                                        ...
		                                        <td><a href="#" onclick="deleteRole('${cargoType.id}')">删除</a></td>
		                                        <td><a href="#" onclick="updateCargoCode('${cargoType.id}')">更新</a></td>
		                                </tr>
										</c:forEach>
                                    </tbody>
                                </table>
...
<script>
    	...
    	if (r==true)
    	  {
    		$.ajax({
    	        type: "post",
    	        url: "/manage/cargoTypeCode/deleteCargoTypeCode",
    	        datatype: "json",
    	        async: false,
    	        data:{
    	            id:id
    	        ...
    	        success:function (data) {
    	        		...
    	        		window.location.href="/manage/cargoTypeCode/queryCargoTypeCode?page="+${page}+"&strip=10";
	...
	function updateCargoCode(id) {

		$.ajax({
	        type: "post",
	        url: "/manage/cargoTypeCode/getCargoTypeCode?id="+id,
	        datatype: "json",
	        async: false,
	        data:{
	            id:id
	        ...
	        success:function () {
	        	window.location.href="/manage/code/updateCargoTypeCode.jsp";
	        },
	        error:function(res){
	            alert("联网失败");
	        }
