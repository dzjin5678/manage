                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="title">码头管理</h4>
                                    </div>
                                    
                                    <div class="col-md-3" >
                                    <br>
                                    <a class="btn btn-primary btn-fill" href="/manage/code/addWharfCode.jsp">添加码头信息</a>
                            		</div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <td><h5>更新</h5></td>
                                  	...
                                  	<tbody>
										<c:forEach items="${getWharfList}" var="wharf" >
										<tr>
		                                        <td>${wharf.wharfCode}</td>
		                                        <td>${wharf.wharfName}</td>
		                                        <td><a href="#" onclick="deleteRole('${wharf.id}')">删除</a></td>
		                                        <td><a href="#" onclick="updateWharf('${wharf.id}')">更新</a></td>
		                                </tr>
										</c:forEach>
                                    </tbody>
                                </table>
...
<script>
    	...
    	if (r==true)
    	  {
    		$.ajax({
    	        type: "post",
    	        url: "/manage/wharfCode/deleteWharfCode",
    	        datatype: "json",
    	        async: false,
    	        data:{
    	            id:id
    	        ...
    	        success:function (data) {
    	        	window.location.href="/manage/wharfCode/queryWharfCodeCode?page="+${page}+"&strip=10";
    	        },
    	        error:function(res){
    	            alert("联网失败");
    	        }
	...
	function updateWharf(id) {

		$.ajax({
	        type: "post",
	        url: "/manage/wharfCode/getWharfCode?id="+id,
	        datatype: "json",
	        async: false,
	        data:{
	            id:id
	        ...
	        success:function () {
	        	window.location.href="/manage/code/updateWharfCode.jsp";
	        },
	        error:function(res){
	            alert("联网失败");
	        }
