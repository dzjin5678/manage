                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="title">船舶动态管理</h4>
                                    </div>
                                    
                                    <div class="col-md-3" >
                                    <br>
                                    <a class="btn btn-primary btn-fill" href="/manage/ship_dynamic/insertbefore?shipForecastId=${shipForecastId }">添加船舶动态信息</a>
                            		</div>
                                </div>
                            </div>
                            <div class="row">
    	...
    	if (r==true)
    	  {
    		$.ajax({
    	        ...
    	        success:function (data) {
    	        	...
    	        	window.location.href="/manage/ship_dynamic/shipdynamic?page="+${page}+"&strip=10&shipForecastId="+${shipForecastId};
