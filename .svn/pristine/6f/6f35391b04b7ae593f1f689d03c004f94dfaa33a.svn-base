                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            ...
                            <div class="content">
                                <form method="post" action="/manage/unitCode/updateUnitCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">


                                    <fieldset>
                                    
                                       <c:forEach items="${unitCodeList}" var="unit" >
                                    
                                        <div class="form-group" style="display:none;">
                                            <label class="col-sm-3 control-label">ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="id" class="form-control" id="number" value="${unit.id}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="unitCode" class="form-control" id="number" value="${unit.unitCode}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="unitName" class="form-control" id="number" value="${unit.unitName}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="unitType" class="form-control" id="number" value="${unit.unitType}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="unitEname" class="form-control" id="number" value="${unit.unitEname}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="address" class="form-control" id="number" value="${unit.address}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="phone" class="form-control" id="number" value="${unit.phone}">
                                            </div>
                                        </div>
                                    ...
                                    <span style="color: #FF0000">${errorInfo}</span><br>
                                         <a href="/manage/unitCode/queryUnitCodeCode?page=1&strip=10" class="btn btn-info btn-fill">返回</a>
