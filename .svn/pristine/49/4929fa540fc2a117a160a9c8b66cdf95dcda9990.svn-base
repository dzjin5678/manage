                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            ...
                            <div class="content">
                                <form method="post" action="/manage/cargoTypeCode/updateCargoTypeCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                    	<c:forEach items="${cargoTypeCodeList}" var="cargoType">
                                    	
                                    	<div class="form-group" style="display:none;">
                                            <label class="col-sm-3 control-label">ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="id" class="form-control" id="number" value="${cargoType.id}">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">货类代码</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="cargoTypeCode" class="form-control" id="number" value="${cargoType.cargoTypeCode}">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">货类名称</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="cargoTypeName" class="form-control" id="number" value="${cargoType.cargoTypeName}">
                                            </div>
                                        </div>
                                    ...
                                    <span style="color: #FF0000">${errorInfo}</span><br>
                                         <a href="/manage/cargoTypeCode/queryCargoTypeCode?page=1&strip=10" class="btn btn-info btn-fill">返回</a>
