                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            <div class="header">
                                <legend>添加货名代码信息</legend>
                            </div>
                            <div class="content">
                                <form method="post" action="/manage/cargoNameCode/insertCargoNameCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">货名代码</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="cargoNameCode" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="cargoTypeBelonged" class="form-control" id="number" >
                                            </div>
                                        </div>
                                    </fieldset>
