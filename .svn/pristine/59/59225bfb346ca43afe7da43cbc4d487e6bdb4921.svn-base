                              ...
                              <form method="post" action="/manage/system/addRole" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">
                                    ...
                                    <fieldset>
                                    	<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" id="password" class="form-control" placeholder="不填写则为原密码">
                                            </div>
                                         </div>
                                    </fieldset>
                                    <fieldset>
                                    	<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" id="realName" class="form-control" value="${userInfo.realName}">
                                            </div>
                                         </div>
                                    </fieldset>
                                    <fieldset>
                                            ...
                                            <select id="role" class="selectpicker" data-title="无" data-style="btn-default btn-block"  data-menu-style="dropdown-blue">
												<c:forEach items="${allRoleList}" var="pg" >
													 <c:if test="${pg.id==userInfo.role}">
				                                     <option value="${pg.id}" selected="selected">${pg.explains}</option>
				                                     </c:if>
				                                     
													 <c:if test="${pg.id!=userInfo.role}">
				                                     <option value="${pg.id}" >${pg.explains}</option>
				                                     </c:if>
												 </c:forEach>
                                             </select>
                                         	 </div>
                                    ...
                                    <fieldset>
                                            ...
                                            <select id="department" class="selectpicker" data-title="无" data-style="btn-default btn-block"  data-menu-style="dropdown-blue">
												...
												<c:if test="${userInfo.department=='总店'}">
				                                     <option value="总店" selected="selected">总店</option>
				                                </c:if>
												<c:if test="${userInfo.department!='总店'}">
				                                     <option value="总店" >总店</option>
				                                </c:if>
				                                
												<c:if test="${userInfo.department=='分店'}">
				                                     <option value="分店" selected="selected">分店</option>
				                                </c:if>
												<c:if test="${userInfo.department!='分店'}">
				                                     <option value="分店" >分店</option>
				                                </c:if>
				                                
												<c:if test="${userInfo.department=='分店1'}">
				                                     <option value="分店1" selected="selected">分店1</option>
				                                </c:if>
												<c:if test="${userInfo.department!='分店1'}">
				                                     <option value="总店" >分店1</option>
				                                </c:if>
                                             </select>
                                         	 </div>
                                         	</div>
                                    ...
                                    <fieldset>
                                            ...
                                            <div class="col-sm-6">
                                            <select id="state" class="selectpicker" data-title="无" data-style="btn-default btn-block"  data-menu-style="dropdown-blue">
                                    ...
                                    <div class="footer text-center">
                                         ...
                                         <a class="btn btn-info btn-fill" href="javascript:updateUser();" >更新</a>
                                    </div>
                                    </form>
                            </div>
                        </div>  <!-- end card -->
