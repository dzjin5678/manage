                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            ...
                            <div class="content">
                                <form method="post" action="/manage/costCode/updateCostCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                    
                                    <c:forEach items="${costCodeList}" var="cost">
                                    
                                        <div class="form-group" style="display:none;">
                                            <label class="col-sm-3 control-label">ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="id" class="form-control" id="number" value="${cost.id}">
                                            </div>
                                        </div>
                                    
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">费目代码</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="costCode" class="form-control" id="number" value="${cost.costCode}">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">费目名称</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="costName" class="form-control" id="number" value="${cost.costName}">
                                            </div>
                                        </div>
                                       	...
                                       	<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="costUnit" class="form-control" id="number" value="${cost.costUnit}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="costRate" class="form-control" id="number" value="${cost.costRate}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="costType" class="form-control" id="number" value="${cost.costType}">
                                            </div>
                                        </div>
                                    ...
                                    <span style="color: #FF0000">${errorInfo}</span><br>
                                         <a href="/manage/costCode/queryCostCodeCode?page=1&strip=10" class="btn btn-info btn-fill">返回</a>
