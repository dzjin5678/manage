                        ...
                        <div class="card">
                            ...
                            <div class="header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">                                        
                                        <h5 class="title">作业单号：${storageTankTask.task }</h5>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3" >
	                                    <br><a class="btn btn-primary btn-fill" href="/manage/code/addStorageTankCargo.jsp">添加储罐详单货物信息</a>
                            		</div>
                            		
                            		<div class="col-md-3" >
	                                    <br><a class="btn btn-danger btn-fill" href="/manage/storageTankTask/queryStorageTankTask?page=1&strip=10">返回储罐详单作业列表</a>
                            		</div>
                                </div>
                            ...
                            <div class="content table-responsive table-full-width">
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <td><h5>更新</h5></td>
                                  	...
                                  	<tbody>
										<c:forEach items="${storageTankCargoList}" var="storageTankCargoTemp" >
										<tr>
	                                        <td>${storageTankCargoTemp.cargoType}</td>
	                                        <td>${storageTankCargoTemp.transportType}</td>
	                                        <td>${storageTankCargoTemp.planNum}</td>
	                                        <td>${storageTankCargoTemp.actualNum}</td>
	                                        <td><a href="#" onclick="deleteStorageTankCargo('${storageTankCargoTemp.id}')">删除</a></td>
	                                        <td><a href="#" onclick="updateStorageTankTask('${storageTankCargoTemp.id}')">更新</a></td>
		                                </tr>
										</c:forEach>
                                    </tbody>
                                </table>
...
<script>
	...
	function deleteStorageTankCargo(id) {
		var r=confirm("删除将无法找回！确定删除？");
    	if (r==true)
    	  {
    		$.ajax({
    	        type: "post",
    	        url: "/manage/storageTankCargo/deleteStorageTankCargo",
    	        datatype: "json",
    	        async: false,
    	        data:{
    	        	id:id
    	        ...
    	        success:function () {
    	        	window.location.href="/manage/storageTankCargo/queryStorageTankCargo?page=1&strip=10";
    	        },
    	        error:function(res){
    	            alert("联网失败");
    	        }
    ...
    $('#box').paging({
        ...
        callback: function(page) { // 回调函数
            console.log(page);
	        if(page!=${page}){
	        	window.location.href="/manage/storageTankCargo/queryStorageTankCargo?page="+page+"&strip=10";
	        }
        }
    })
