                        ...
                        <div class="card">
                             <div class="header">
                                <div class="row">
                                    ...
                                    <div class="col-md-3" >
                                    <br>
                                    <a class="btn btn-primary btn-fill" href="/manage/sys/addRole.jsp">添加角色</a>
                            		</div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="content table-responsive table-full-width">
								...
								<c:forEach items="${getRoleList}" var="pg" >
								<tr>
                                        <td>${pg.explains}</td>
                                        <td><a href="/manage/system/getPowerList?roleId=${pg.id}&page=1&strip=10&roleName=${pg.explains}">查看权限</a></td>
                                        <td><a onclick="deleteRole('${pg.id}')">删除</a></td>
                                </tr>
								</c:forEach>
                                    </tbody>
                                </table>
