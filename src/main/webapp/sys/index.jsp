    ...
    $('#box').paging({
        ...
        if(page!=${page}){
        	...
        	if(startDate==""||endDate==""){
            	window.location.href="/get/financialManage?page="+page+"&strip=10";
        	}else{
            	window.location.href="/get/financialManage?page="+page+"&strip=10&startDate="+startDate+"&endDate="+endDate;
        	}
        }
        }
    })

		var int=self.setInterval("getNoticeState()",5000);
		var ii=0;
		function getNoticeState()
		{
		    $.ajax({
		        type: "post",
		        url: "/order/getNoticeState",
		        datatype: "json",
		        async: false,
