                              ...
                              <form method="post" action="/manage/system/addRole" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">
                                    ...
                                    <fieldset>
                                     ...
                                     <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" id="reservoirArea" class="form-control" >
                                            </div>
                                         </div>
                                    </fieldset>
									...
									<fieldset>
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-sm-6">
													<input type="text" id="startTime" class="form-control datetimepicker" placeholder="请选择时间"/>
												</div>
	                                         </div>
	                                </fieldset>
                                    ...
                                    <div class="footer text-center">
                                         ...
                                         <a class="btn btn-info btn-fill" href="javascript:addGoodsTask();" >添加</a>
                                    </div>
                                    </form>
                            </div>
                        </div>  <!-- end card -->
...
$().ready(function(){
    ...
    demo.initFormExtendedDatetimepickers();
		...
		function addGoodsTask() {
            
            
			var reservoirArea=document.getElementById("reservoirArea").value;
