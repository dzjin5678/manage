                              ...
                              <form method="post" action="/manage/system/addRole" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">
									...
									<fieldset>
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-sm-6">
													<input type="text" id="connectionTime" class="form-control datetimepicker" placeholder="请选择时间"/>
												</div>
	                                         </div>
	                                </fieldset>
									...
									<fieldset>
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-sm-6">
													<input type="text" id="startPump" class="form-control datetimepicker" placeholder="请选择时间"/>
												</div>
	                                         </div>
	                                </fieldset>
									...
									<fieldset>
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-sm-6">
													<input type="text" id="stopTime" class="form-control datetimepicker" placeholder="请选择时间"/>
												</div>
	                                         </div>
	                                </fieldset>
									...
									<fieldset>
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-sm-6">
													<input type="text" id="disconnectTime" class="form-control datetimepicker" placeholder="请选择时间"/>
												</div>
	                                         </div>
	                                </fieldset>
									...
									<fieldset>
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-sm-6">
													<input type="text" id="unberthingTime" class="form-control datetimepicker" placeholder="请选择时间"/>
												</div>
	                                         </div>
	                                </fieldset>
									...
									<fieldset>
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-sm-6">
													<input type="text" id="operationTime" class="form-control datetimepicker" placeholder="请选择时间"/>
												</div>
	                                         </div>
	                                </fieldset>
									...
									<fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" id="inBerthTime" class="form-control" >
                                            </div>
                                         </div>
                                    </fieldset>
                                    ...
                                    <div class="footer text-center">
                                         ...
                                         <a class="btn btn-info btn-fill" href="javascript:addShipOperation();" >添加</a>
                                    </div>
                                    </form>
                            </div>
                        </div>  <!-- end card -->
...
function addShipOperation() {
	...
	$.ajax({
        type: "post",
        url: "/manage/tack/addShipOperation",
        datatype: "json",
        async: false,
        data:{
        	dynamicId:dynamicId,
        ...
        success:function (data) {
        	...
        	if(dat.expect){
        		window.location.href="/manage/tack/getShipOperationList?page=${page}&strip=10&dynamicId=${dynamicId}";
        	}else{
        		alert(dat.msg);
        	}
