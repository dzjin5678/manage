                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="title">船舶外贸提单表</h4>
                                    </div>
                                    
                                    <!-- <div class="col-md-3" >
                                    <br>
                                    <a class="btn btn-primary btn-fill" href="/manage/ship_table/add_ship_information.jsp">添加船舶信息</a>
                            		</div> -->
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <td><h5>船舶外贸提单表</h5></td>
                                  	...
                                  	<tbody>
										...
										<tr>
		                                        ...
		                                        <td>${sfc.netWeight}</td>
		                                        <%-- <td><fmt:formatDate value="${sfc.arrivalTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td> --%>
		                                        <td>${sfc.arrivalTime}</td>
		                                        <%-- <td><a href="#" onclick="deleteShipInformation('${sfc.id}')">删除</a></td>
		                                        <td><a href="/manage/ship_information/updatebefore?id=${sfc.id}">编辑</a></td> --%>
		                                        <td><a href="/manage/ship_foreign_trade_bill/list?shipInformationId=${sfc.id}">查看详情</a></td>
		                                </tr>
										</c:forEach>
                                    </tbody>
                                </table>
...
<script>
	...
	function deleteShipInformation(id) {
		var r=confirm("删除将无法找回！确定删除？");
    	if (r==true)
    	  {
    		$.ajax({
    	        type: "post",
    	        url: "/manage/ship_information/delete",
    	        datatype: "json",
    	        async: false,
    	        data:{
    	            id:id
    	        ...
    	        success:function (data) {
    	        	var dat=JSON.parse(data);
    	        		window.location.href="/manage/ship_information/list?page="+${page}+"&strip=10"; 
    	        	alert("删除成功");
    	        },
    	        error:function(res){
    	            alert("联网失败");
