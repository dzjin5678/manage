                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            <div class="header">
                                <legend>添加外贸提单信息</legend>
                            </div>
                            <div class="content">
                                <form method="post" action="/manage/ship_foreign_trade_bill/insert" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">船舶信息表ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="shipInformationId" class="form-control" id="shipInformationId" value="${shipInformationId }"  readonly="readonly">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="billNumber" class="form-control" id="billNumber" >
                                            </div>
                                        </div>
                                    ...
                                    <span style="color: #FF0000">${errorInfo}</span><br>
                                         <a href="/manage/ship_foreign_trade_bill/list?shipInformationId=${shipInformationId }" class="btn btn-info btn-fill">返回</a>
