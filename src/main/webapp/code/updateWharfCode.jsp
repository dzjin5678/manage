                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            ...
                            <div class="content">
                                <form method="post" action="/manage/wharfCode/updateWharfCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">
					
                                    <fieldset>
                                    <c:forEach items="${wharfCodeList}" var="wharfCode">
                                    
                                       	<div class="form-group" style="display:none;">
                                            <label class="col-sm-3 control-label">ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="id" class="form-control" id="number" value="${wharfCode.id}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">码头代码</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="wharfCode" class="form-control" id="number" value="${wharfCode.wharfCode}">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">码头名称</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="wharfName" class="form-control" id="number" value="${wharfCode.wharfName}">
                                            </div>
                                        </div>
                                        </c:forEach>
                                    </fieldset>
                                    ...
                                    <span style="color: #FF0000">${errorInfo}</span><br>
                                         <a href="/manage/wharfCode/queryWharfCodeCode?page=1&strip=10" class="btn btn-info btn-fill">返回</a>
