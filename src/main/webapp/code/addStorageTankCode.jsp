                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:1000px">
                            ...
                            <div class="content">
                                <form method="post" action="/manage/storageTankCode/insertStorageTankCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">储罐列位置</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="tankColumn" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="storageTankNumber" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="storageTankPosition" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="storageTankCapacity" class="form-control" id="number" >
                                            </div>
                                        </div>
