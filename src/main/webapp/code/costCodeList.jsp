                        ...
                        <div class="card">
                             <div class="header">
                                <div class="row">
                                    ...
                                    <div class="col-md-3" >
                                    <br>
                                    <a class="btn btn-primary btn-fill" href="/manage/code/addCostCode.jsp">添加费用信息</a>
                            		</div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <td><h5>更新</h5></td>
                                  	...
                                  	<tbody>
										...
										<tr>
		                                        ...
		                                        <td>${cost.costRate}</td>
		                                        <td>${cost.costType}</td>
		                                        <td><a href="#" onclick="deleteRole('${cost.id}')">删除</a></td>
		                                        <td><a href="#" onclick="updateCost('${cost.id}')">更新</a></td>
										</c:forEach>
                                    </tbody>
                                </table>
...
<script>
    	...
    	if (r==true)
    	  {
    		$.ajax({
    	        type: "post",
    	        url: "/manage/costCode/deleteCostCode",
    	        datatype: "json",
    	        async: false,
    	        data:{
    	            id:id
    	        ...
    	        success:function (data) {
    	        		window.location.href="/manage/costCode/queryCostCodeCode?page="+${page}+"&strip=10";
    	        },
    	        error:function(res){
    	            alert("联网失败");
    	        }
	...
	function updateCost(id) {
		...
		$.ajax({
	        type: "post",
	        url: "/manage/costCode/getCostCode?id="+id,
	        datatype: "json",
	        async: false,
	        data:{
	            id:id
	        ...
	        success:function () {
	        	window.location.href="/manage/code/updateCostCode.jsp";
	        },
	        error:function(res){
	            alert("联网失败");
	        }
