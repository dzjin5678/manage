                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="title">库场管理</h4>
                                    </div>
                                    
                                    <div class="col-md-3" >
                                    <br>
                                    <a class="btn btn-primary btn-fill" href="/manage/code/addStorageCode.jsp">添加库场信息</a>
                            		</div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <td><h5>更新</h5></td>
                                  	...
                                  	<tbody>
										...
										<tr>
		                                        ...
		                                        <td>${storage.storagePosition}</td>
		                                        <td><a href="#" onclick="deleteRole('${storage.id}')">删除</a></td>
		                                        <td><a href="#" onclick="updateStorage('${storage.id}')">更新</a></td>
		                                </tr>
										</c:forEach>
                                    </tbody>
                                </table>
...
<script>
    	...
    	if (r==true)
    	  {
    		$.ajax({
    	        type: "post",
    	        url: "/manage/storageCode/deleteStorageCode",
    	        datatype: "json",
    	        async: false,
    	        data:{
    	            id:id
    	        ...
    	        success:function (data) {
    	        		window.location.href="/manage/storageCode/queryStorageCodeCode?page="+${page}+"&strip=10";
	...
	function updateStorage(id) {
		...
		$.ajax({
	        type: "post",
	        url: "/manage/storageCode/getStorageCode?id="+id,
	        datatype: "json",
	        async: false,
	        data:{
	            id:id
	        ...
	        success:function () {
	        	window.location.href="/manage/code/updateStorageCode.jsp";
	        },
	        error:function(res){
	            alert("联网失败");
	        }
