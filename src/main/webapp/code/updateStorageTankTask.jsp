                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:1000px">
                            <div class="header">
                                <legend>更新储罐详单作业</legend>
                            </div>
                            <div class="content">
                                <form method="post" action="/manage/storageTankTask/updateStorageTankTask" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                        <div class="form-group" style="display:none;">
                                            <label class="col-sm-3 control-label">ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="id" class="form-control" value="${storageTankTask.id }" >
                                            </div>
                                        </div>
                                    	...
                                    	<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="storageTankNumber" class="form-control" value="${storageTankTask.storageTankNumber }" readonly="${storageTankTask.storageTankNumber }" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="contract" class="form-control" value="${storageTankTask.contract }" readonly="${storageTankTask.contract }" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="task" class="form-control" value="${storageTankTask.task }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="notify" class="form-control" value="${storageTankTask.notify }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="ladingBill" class="form-control" value="${storageTankTask.ladingBill }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" name="customPassFile" class="form-control" value="不更改原有文件">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="date" name="loadUnloadDatetime" class="form-control" value="${storageTankTask.loadUnloadDatetime }">
                                            </div>
                                        </div>
