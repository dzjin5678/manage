                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            ...
                            <div class="content">
                                <form method="post" action="/manage/cargoTypeCode/insertCargoTypeCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">货类代码</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="cargoTypeCode" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="cargoTypeName" class="form-control" id="number" >
                                            </div>
                                        </div>
