                        ...
                        <div class="card">
                             <div class="header">
                                <div class="row">
                                    ...
                                    <div class="col-md-3" >
                                    <br>
                                    <a class="btn btn-primary btn-fill" href="/manage/code/addUnitCode.jsp">添加单位信息</a>
                            		</div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <td><h5>更新</h5></td>
                                  	...
                                  	<tbody>
										<c:forEach items="${getUnitList}" var="unit" >
										<tr>
		                                        <td>${unit.unitCode}</td>
		                                        <td>${unit.unitName}</td>
		                                        <td>${unit.unitType}</td>
		                                        ...
		                                        <td>${unit.address}</td>
		                                        <td>${unit.phone}</td>
		                                        <td><a href="#" onclick="deleteRole('${unit.id}')">删除</a></td>
		                                        <td><a href="#" onclick="updateUnit('${unit.id}')">更新</a></td>
		                                </tr>
										</c:forEach>
                                    </tbody>
                                </table>
