                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            ...
                            <div class="content">
                                <form method="post" action="/manage/storageCode/updateStorageCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                    <c:forEach items="${storageCodeList}" var="storage">
                                    
                                       <div class="form-group" style="display:none;">
                                            <label class="col-sm-3 control-label">ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="id" class="form-control" id="number" value="${storage.id }">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">库场代码</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="storageCode" class="form-control" id="number" value="${storage.storageCode }">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">库场名称</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="storageName" class="form-control" id="number" value="${storage.storageName }">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">库场位置</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="storagePosition" class="form-control" id="number" value="${storage.storagePosition }">
                                            </div>
                                        </div>
                                        </c:forEach>
                                    </fieldset>
                                    ...
                                    <span style="color: #FF0000">${errorInfo}</span><br>
                                         <a href="/manage/storageCode/queryStorageCodeCode?page=1&strip=10" class="btn btn-info btn-fill">返回</a>
