                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            <div class="header">
                                <legend>添加库场代码</legend>
                            </div>
                            <div class="content">
                                <form method="post" action="/manage/storageCode/insertStorageCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">库场代码</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="storageCode" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="storageName" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="storagePosition" class="form-control" id="number" >
                                            </div>
                                        </div>
                                    </fieldset>
