                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:1000px">
                            <div class="header">
                                <legend>添加储罐合同</legend>
                            </div>
                            <div class="content">
                                <form method="post" action="/manage/storageTankContract/insertStorageTankContract?storageTankNumber=${storageTankNumber}" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                    	<div class="form-group">
                                            <label class="col-sm-3 control-label">储罐编号</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="number" value="${storageTankNumber}" readonly="${storageTankNumber}" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="client" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="contract" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="cargoName" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="P15" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="DCF" class="form-control" id="number" >
                                            </div>
                                        </div>
