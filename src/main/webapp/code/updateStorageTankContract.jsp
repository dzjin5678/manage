                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:1000px">
                            <div class="header">
                                <legend>更新储罐合同</legend>
                            </div>
                            <div class="content">
                                <form method="post" action="/manage/storageTankContract/updateStorageTankContract" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                    <c:forEach items="${storageTankContracts}" var="torageTankContract">
                                    
                                       <div class="form-group" style="display:none;">
                                            <label class="col-sm-3 control-label">ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="id" class="form-control" id="number" value="${torageTankContract.id}">
                                            </div>
                                        </div>
                                    	<div class="form-group">
                                            <label class="col-sm-3 control-label">储罐编号</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="storageTankNumber" class="form-control" id="number" value="${storageTankNumber}" readonly="${storageTankNumber}" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="client" class="form-control" id="number" value="${torageTankContract.client}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="contract" class="form-control" id="number" value="${torageTankContract.contract}">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">货品名称</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="cargoName" class="form-control" id="number" value="${torageTankContract.cargoName}">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">P15空气密度</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="P15" class="form-control" id="number" value="${torageTankContract.p15}">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">DCF</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="DCF" class="form-control" id="number" value="${torageTankContract.dcf}">
                                            </div>
                                        </div>
										</c:forEach>
                                    </fieldset>
                                    ...
                                    <span style="color: #FF0000">${errorInfo}</span><br>
                                         <a href="/manage/storageTankContract/queryStorageTankContract?page=1&strip=10&storageTankNumber=${storageTankNumber}" class="btn btn-info btn-fill">返回</a>
                                         <input type="submit" class="btn btn-info btn-fill" value="更新储罐合同"/>
                                    </div>
                                </form>
                            </div>
                        </div>  <!-- end card -->
