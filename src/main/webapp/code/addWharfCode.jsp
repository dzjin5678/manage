                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            ...
                            <div class="content">
                                <form method="post" action="/manage/wharfCode/insertWharfCode" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">码头代码</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="wharfCode" class="form-control" id="number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="wharfName" class="form-control" id="number" >
                                            </div>
                                        </div>
                                    </fieldset>
