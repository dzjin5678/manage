                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height:700px">
                            <div class="header">
                                <legend>修改船舶预报信息</legend>
                            </div>
                            <div class="content">
                                <form method="post" action="/manage/ship_forecast/update" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">

                                    <fieldset>
                                    <input name="id" type="hidden" value="${requestScope.shipForecast.id }"></input> 
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">船舶代码</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="shipCode" class="form-control" id="shipCode" value="${requestScope.shipForecast.shipCode }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="voyageNumber" class="form-control" id="voyageNumber" value="${requestScope.shipForecast.voyageNumber }">
                                            </div>
                                        </div>
                                       	...
                                       	<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="importVoyage" class="form-control" id="importVoyage" value="${requestScope.shipForecast.importVoyage }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="exportVoyage" class="form-control" id="exportVoyage" value="${requestScope.shipForecast.exportVoyage }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="noticeNumber" class="form-control" id="noticeNumber" value="${requestScope.shipForecast.noticeNumber }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="affiliatedCompany" class="form-control" id="affiliatedCompany" value="${requestScope.shipForecast.affiliatedCompany }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="proxy" class="form-control" id="proxy" value="${requestScope.shipForecast.proxy }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <%-- <input type="text" name="iFTrade" class="form-control" id="iFTrade" value="${requestScope.shipForecast.iFTrade }"> --%>
                                                <select name="iFTrade" class="selectpicker" data-title="请选择" data-style="btn-default btn-block" data-menu-style="dropdown-blue" >
	                                                <option value="0" <c:if test="${'0' eq requestScope.shipForecast.iFTrade }">selected</c:if> >内贸</option>
	                                                <option value="1" <c:if test="${'1' eq requestScope.shipForecast.iFTrade }">selected</c:if> >外贸</option>
	                                            </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" min="0.00" step="0.01" name="grossWeight" class="form-control" id="grossWeight" value="${requestScope.shipForecast.grossWeight }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" min="0.00" step="0.01" name="netWeight" class="form-control" id="netWeight" value="${requestScope.shipForecast.netWeight }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="expectedArrivalTime" class="form-control datetimepicker" id="expectedArrivalTime" value="${requestScope.shipForecast.expectedArrivalTime }">
                                            </div>
                                        </div>
